...
# Usage: From the project folder (e.g. 'ios-eventsource') run 'bash .circleci/run-build-locally.sh'
...
curl --user ${CIRCLE_TOKEN}: \
     ...
     --form notify=false \
        https://circleci.com/api/v1.1/project/github/launchdarkly/ios-eventsource/tree/master
